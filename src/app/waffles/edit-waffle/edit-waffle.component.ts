...
@Component({
  ...
  styleUrls: ['./edit-waffle.component.css']
})
export class EditWaffleComponent {
  ...
  anadirWaffle(){
    ...
    this.add.updateOrden(id, this.Orden).subscribe(
      res => {
        console.log(res);
        if(this.authService.lang() === 'es'){
          this.alertService.mostrarAlerta('Su waffle fue actualizado');
          }else if(this.authService.lang() === 'en'){
            this.alertService.mostrarAlerta('Your waffle was updated');
          }
